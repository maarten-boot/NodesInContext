"""
Django settings for pNic project.
...
INSTALLED_APPS = [
    "aNode.apps.AnodeConfig",
    "aContext.apps.AcontextConfig",
    "aMain.apps.AmainConfig",
    #
    "drf_spectacular",
    "rest_framework",
    "django_filters",
...
WSGI_APPLICATION = "pNic.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "NodesInContext",
    "DESCRIPTION": "Organizing relations between Nodes",
    "VERSION": "0.1.0",
